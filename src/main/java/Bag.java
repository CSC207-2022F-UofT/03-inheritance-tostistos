...
public abstract class Bag {
     ...
     */
    public void setColor(String to_set){
        this.color = to_set;
    }
     ...
     *       and false otherwise.
     */
    public boolean addItem(String bagged_item){
        if (this.numberOfContents < this.capacity){
            this.contents[this.numberOfContents] = bagged_item;
    ...
    public String popItem(){
        if (this.numberOfContents == 0){
            ...
            String popped_item = this.contents[this.numberOfContents - 1];
